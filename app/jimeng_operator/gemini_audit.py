...
- 如果主角脸部在关键帧里明显变脸、五官比例变化、脸太小、太糊或无法稳定辨认，不能 approve。
- 如果画面里出现中景或前景人物，但面部缺失、面部崩坏或像未完成的人形，也不能 approve。
- 对本项目默认更偏保守：宁可因为主角脸不够稳而 revise，也不要放过“勉强能看”的片子。
